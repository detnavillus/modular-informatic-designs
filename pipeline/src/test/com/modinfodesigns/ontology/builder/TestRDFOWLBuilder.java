...
public class TestRDFOWLBuilder extends TestCase
{
  ...
  {
    RDFOWLOntologyBuilder rdfOwlBuilder = new RDFOWLOntologyBuilder( );
    ITaxonomyNode onto = rdfOwlBuilder.buildTaxonomy( new StringReader( music_example ) );
      
    System.out.println( "Got ontology: " + onto.getValue( IProperty.JSON_FORMAT ) );
  }
